...
// import { getDepartmentSchema, getRoleSchema } from "../Validations/ValidationSchema";
...
//   const [adddepartment, SetAddDepartment] = useState<DepartmentFormData[]>([]);
...
//       const response = await showDepartment();
//       const data = response.data;
//       SetAddDepartment(Array.isArray(data) ? data : []);
//       setSnackbarMessage("✅ User added successfully!");
//       setSnackbarSeverity("success");
//     }
//     catch (error) {
...
//     }
//   };
//   const handleRole: SubmitHandler<Department> = async (data: Department) => {
//     try {
//       const response = await addDepartment(data.name);
//       console.log(response.data.data);
...
//             render={({ field }) => (
//               <Autocomplete
//                 options={adddepartment.map((item) => item.name)} // <- only use names
...
//         </form>
//       </Modal>
//       <Modal open={OpenRole} onClose={handleAddDepartmentClose}>
